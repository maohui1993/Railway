...
import cn.dazhou.im.adapter.EmotionGridViewAdapter;
import cn.dazhou.im.adapter.EmotionPagerAdapter;
import cn.dazhou.im.util.EmotionUtils;
import cn.dazhou.im.util.GlobalOnItemClickManagerUtils;
import cn.dazhou.im.util.Utils;
import cn.dazhou.im.widget.IndicatorView;
...
public class ChatEmotionFragment extends BaseFragment {
    ...
    private void initEmotion() {
        DisplayMetrics curMetrics = getContext().getApplicationContext().getResources().getDisplayMetrics();
        // 获取屏幕宽度
